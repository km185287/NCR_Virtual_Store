...
function CreateStore({route,navigation}) {
    ...
    const formCameraImages = () => {
        ...
        navigation.navigate('DupCreateStore',{result:result});
    };
    ...
    useEffect(() => {
        ...
        var pics = route.params.Images[0];
        pics = pics.split(',');
        pics = pics.toString();
        console.log("testing pics",typeof(pics),pics);
